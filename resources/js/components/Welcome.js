...
const Welcome = () => {
    return <WelcomeCard>
        ...
        <p>Welcome to your new, fresh Laravel + React + Ant Design app! The foundation is complete, now you can have fun with your next project!</p>

        <p>You will find this component in the <i>resources/js/components/Welcome.js</i> file. You can easily remove it and start your work.</p>

        <Divider />

        <h2>Useful Laravel Links</h2>
        <ul>
            <li><a target="_blank" href="https://laravel.com/docs">Docs</a></li>
            <li><a target="_blank" href="https://laracasts.com">Laracasts</a></li>
            <li><a target="_blank" href="https://laravel-news.com">News</a></li>
            <li><a target="_blank" href="https://blog.laravel.com">Blog</a></li>
            <li><a target="_blank" href="https://nova.laravel.com">Nova</a></li>
            <li><a target="_blank" href="https://forge.laravel.com">Forge</a></li>
            <li><a target="_blank" href="https://vapor.laravel.com">Vapor</a></li>
            <li><a target="_blank" href="https://github.com/laravel/laravel">GitHub</a></li>
        </ul>

        <Divider />

        <h2>Userful Antd Links</h2>

        <ul>
            <li><a target="_blank" href="https://ant.design/">Main Site</a></li>
            <li><a target="_blank" href="https://ant.design/docs/spec/introduce">Design</a></li>
            <li><a target="_blank" href="https://ant.design/docs/react/introduce">Docs</a></li>
            <li><a target="_blank" href="https://ant.design/components/overview/">Components</a></li>
            <li><a target="_blank" href="https://ant.design/docs/resources">Resources</a></li>
            <li><a target="_blank" href="https://github.com/ant-design/ant-design/">GitHub</a></li>
        </ul>

        <Divider />

        <Footer>The awesome top banner is available on <a href="https://undraw.co/" target="_blank">Undraw</a>.</Footer>
    </WelcomeCard>
};
